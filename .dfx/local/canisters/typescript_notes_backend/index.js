...
import { idlFactory } from './typescript_notes_backend.did.js';
export { idlFactory } from './typescript_notes_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TYPESCRIPT_NOTES_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./typescript_notes_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the typescript_notes_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./typescript_notes_backend.did.js")._SERVICE>}
 */
export const typescript_notes_backend = createActor(canisterId);
